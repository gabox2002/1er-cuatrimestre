...
def animar_personaje(pantalla, rectangulo_personaje, accion_personaje):
    global contador_pasos#para usar la variable que ya esta en el main
...
def actualizar_pantalla(pantalla, que_hace, velocidad, rectangulo_personaje: pygame.rect, piso):
    global desplazamiento_y, esta_saltando
    match que_hace:
        case "Derecha":
...
reescalar_imagen(lista_animaciones, 100, 200)
...
while True:
    ...
    PANTALLA.blit(fondo, (0,0))
    actualizar_pantalla(PANTALLA, que_hace, velocidad, rectangulo_personaje, piso)
